    ...
    <div>
      <Grid className='bg-black text-white text-center mt-10'
        ...
        <Grid item xs={12} sm={6} md={3}>
          <Typography className='pb-5' variant='h6'>Compony</Typography>
          <div>
      ...
      <Grid className='pt-20 bg-black text-white text-center' item sx={12}>
        <Typography variant='body2'>&copy; 2023 My Compony. All rights reserved</Typography>
        <Typography variant='body2'>Made with love by Me.</Typography>
        <Typography variant='body2'>Icons made by{' '}
